...
local opcode, funct3, funct7 = getOpcodeAndFuncsForMnemonic("sltu")

describe("sltu", function()
    local cpu
    ...
    it("sets rd value to 1 if rs1 < rs2 (with rs1 = 0xffffffff)", function()
        cpu.registers[1] = 0
    ...
    it("sets rd value to 0 if rs1 > rs2 (with rs2 = 0xffffffff)", function()
        cpu.registers[1] = 1
        cpu.registers[2] = 2
