...
local opcode, funct3, funct7 = getOpcodeAndFuncsForMnemonic("slti")

describe("slti", function()
    local cpu
    ...
    it("sets rd value to 1 if rs1 < imm (with negative rs1)", function()
        cpu.registers[1] = 0
    ...
    it("sets rd value to 0 if rs1 > imm (with negative imm)", function()
        cpu.registers[1] = 1
        cpu.registers[2] = 2
        instructionData.rd = 1
        instructionData.rs1 = 2
